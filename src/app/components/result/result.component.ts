 ...
 * ResultComponent
 * 
 * Este componente muestra los resultados después de que el usuario ha realizado una acción.
 * Incluye descripciones, números de la suerte y cartas seleccionadas.
 */
@Component({
  selector: 'app-result',
...
export class ResultComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    /* Metodo que valida si el pago fue aprovado para desbloquear
  ...
  /* Ventana emergente de información sobre la descripción de las cartas */
  showSweetAlert(): void {
    Swal.fire({
  ...
  /* Metodo para hacer el llamado de la mensajería para que el usuario pueda conectar con el 
  * maestro 
  */
  submitPhone(): void {
